      ...
      <main className="legalPage">
        <div className="legalContainer">
          ...
          <ul>
            ...
            <li>On Android: interception of notifications, SMS, call logs, and location data</li>
            <li>Encrypted local log files stored on the host machine or device using AES-256-GCM</li>
          </ul>
          <p>
